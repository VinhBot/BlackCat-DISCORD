...
class CashCommand extends commandBuilder {
  constructor() {
    super({
      ...
      aliases: ["money", "balance"], // lệnh phụ
      description: "Xem số tiền còn lại trong ví và ngân hàng của bạn", // mô tả dành cho lệnh
...
export default new CashCommand();